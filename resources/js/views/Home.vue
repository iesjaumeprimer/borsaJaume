<template>
  <div>
    ...
    <p>Aquesta és la Borsa de Treball del CIP FP Batoi. 
    ...
    <p>Per a les empreses oferim una gran bolsa de professionals que han
      s'han preparat en el nostre Centre y que pensem que s'adaptaran
      perfectament als seus requeriments.
    </p>
    <p>Una vegada publicada una oferta podem veure el curriculum de les
    ...
    <p>El primer pas per a participar en la Borsa, tant si eres empresa 
      com alumne, és <a @click.prevent="$router.push('/register')">registrar-te</a> i crear el teu compte. Si ja el tens només 
